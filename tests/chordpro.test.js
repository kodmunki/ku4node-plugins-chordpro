...
exports['load/read'] = function (test) {
    ...
    var parser = $parser().load(lyrics),
        ...
        expectedValue = "<title>My Song Title</title>{artist: My Artist}Here is <span class=\"note\">A</span> lyric for you";
