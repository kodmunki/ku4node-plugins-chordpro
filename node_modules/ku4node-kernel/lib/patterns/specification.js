...
abstractSpec.prototype.$isSatisfiedBy = function(v) { return; }
abstractSpec.prototype.isSatisfiedBy = function(v) {return this.$isSatisfiedBy(v);}
abstractSpec.prototype.and = function(spec) { return new andSpec(this, spec); }
abstractSpec.prototype.or = function(spec) { return new orSpec(this, spec); }
abstractSpec.prototype.xor = function(spec) { return new xorSpec(this, spec); }
abstractSpec.prototype.not = function() { return new notSpec(this); }
